...
export default function HumorMixPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-6">Humor Mix</h1>
...
function EditModal({ columns, initialValues, onClose, onSave }: {
  columns: string[]; initialValues: Record<string, unknown>; onClose: () => void; onSave: (values: Record<string, unknown>) => Promise<void>;
}) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-zinc-900 border border-pink-500/20 rounded-2xl p-6 max-w-lg w-full mx-4 max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <h2 className="text-lg font-semibold text-white mb-4">Edit Humor Mix</h2>
